...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
    ...
    <div class="w3-bar-block">
        ...
        <a href="{{ route('birds.index') }}" class="w3-bar-item w3-button w3-padding"><i
                class="fa fa-twitter fa-fw"></i> Birds</a>
        <a href="{{ route('locations.index') }}" class="w3-bar-item w3-button w3-padding"><i
        ...
        <a href="{{ route('birds.create') }}" class="w3-bar-item w3-button w3-padding"><i class="fa fa-plus fa-fw"></i>
            Create Bird</a><br><br>
    </div>
</nav>
