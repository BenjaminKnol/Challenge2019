/* Script gedownload vanaf Tiny GPS++ library example
...
static const uint32_t GPSBaud = 4800;   // REGEL ZELF OUT-COMMENTED
//static const uint32_t GPSBaud = 9600;     // REGEL ZELF TOEGEVOEGD!!
