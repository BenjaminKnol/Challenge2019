/* Script gedownload vanaf https://www.instructables.com/id/How-to-Communicate-Neo-6M-GPS-to-Arduino/
...
SoftwareSerial mySerial(gpsBoardTX, gpsBoardRX); // RX, TX  // ZELF TX EN RX VARIABLES TOEGEVOEGD
TinyGPS gps;
